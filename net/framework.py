...
class YOLO(framework):
    ...
    #getProcessedBoxes = yolo.getProcessedBoxes
    #drawAndSaveResults = yolo.drawAndSaveResults
...
class YOLOv2(framework):
    ...
    getProcessedBoxes = yolov2.test.getProcessedBoxes
    drawAndSaveResults = yolov2.test.drawAndSaveResults
    preprocess = yolo.test.preprocess
